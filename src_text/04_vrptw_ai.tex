        ...
        \begin{algorithm}[H]
            ...
            \For{$epoche = 1, 2, \cdots, E$}{
                \For{$steps = 1, 2, \cdots, T$}{
                    Compute multiple vehicles context embedding - encode
                    Compute a new context embedding - decode
                }
            Compute the output probability vector - final layer - log prob
